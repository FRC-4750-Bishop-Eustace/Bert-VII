...
public class Arm extends Subsystem {
    ...
    public Arm() {
        ...
        armMaster.configSelectedFeedbackSensor(FeedbackDevice.CTRE_MagEncoder_Relative, RobotMap.PID_INDEX,
                RobotMap.TIMEOUT);
        ...
        armMaster.setSelectedSensorPosition(absolutePosition, 0, 30);
    }
